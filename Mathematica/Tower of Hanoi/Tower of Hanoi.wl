...
(*drawHanoi[state:{a_,b_,c_}]:=Block[{n=Total[Length/@state],rods,disks,colors,labels},colors=ColorData["TemperatureMap"]/@Range[0,1,1/n];rods=Graphics[{Thick,Line[{{0,0},{0,n}}],Line[{{-n,0},{-n,n}}],Line[{{n,0},{n,n}}]}];labels=Graphics[{Text[Style["a",16,Bold],{-n,-1}],Text[Style["b",16,Bold],{0,-1}],Text[Style["c",16,Bold],{n,-1}]}];disks=MapIndexed[disck[#1,#2//First,n]&,state];Show[rods,disks,labels,PlotRange->{{-2n,2n},{-1.5,n+1}},Axes->False]]*)
